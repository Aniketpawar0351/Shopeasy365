...
include("database.php");
 ...
 <?php
 $temp_sess7=$_SESSION['special_id'];
 $table_name10="{$temp_sess7}borrow";
 ...
 if(isset($_POST['submit_p'])){
   ...
   $sql=mysqli_query($con,"INSERT INTO $table_name10 (`BID`, `BCUSTOMER_NAME`, `BDATE`, `BPRODUCTS`, `BTOTALBILL_AMOUNT`, `BGAIN_AMOUNT`, `BBORROWING_REASON`,`bmobile_no`, `BBORROWING_AMOUNT`, `last_update_date`) VALUES (NULL, '$bname', '$bdate', '$bproduct_data', '$btotal_bill', '$bgain', '$breason','$bmobile_no','$btotal','$date')");
   if($sql){
